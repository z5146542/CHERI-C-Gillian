...
export_code (* Utility Functions *)
            null_capability init_heap next_block get_memory_leak_size get_unfreed_blocks
            (* Memory Actions *)
            ...
            set_glob_var
            (* Value Conversions *)        
            word8_of_integer   word16_of_integer  word32_of_integer  word64_of_integer
