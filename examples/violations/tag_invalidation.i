# 0 "../CHERI-C-Gillian/examples/violations/tag_invalidation.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../CHERI-C-Gillian/examples/violations/tag_invalidation.c"
...
# 2 "../CHERI-C-Gillian/examples/violations/tag_invalidation.c" 2
...
# 3 "../CHERI-C-Gillian/examples/violations/tag_invalidation.c" 2
